...
\subsubsection{   Dữ liệu  }
   ...
   Tiếp theo là ma trận P gồm các số nguyên trong khoảng [0, 100] kích thước 2\textasciicircumN * 2\textasciicircumN. Trong đó P[x, y] là tỉ lệ phần trăm khả năng đội x thắng được đội y khi 2 đội gặp nhau. Dữ liệu đảm bảo P[x, y] + P[y, x] = 100; P[x, x] = 0.  
