...
Dòng 1: Gồm 2 số M và N ( M,N $<$= 100 )

M dòng tiếp theo, mỗi dòng gồm N ký tự dạng ‘P’ , ’K’ , ’.’

M dòng tiếp theo, mỗi dòng gồm N số chỉ độ cao ( 0 $<$= H[i][j] $<$= 10\textasciicircum9 )
...
8\end{verbatim}
\begin{verbatim}
\textbf{Giới hạn: 50% số test có N,M$<$=60 và N*M $<$= 2500}\end{verbatim}