...
Dòng đầu gồm 3 số nguyên dương M,N,Q ( 1 $<$= M,N $<$= 500; 1 $<$= Q $<$= 10\textasciicircum4)

M dòng sau, mỗi dòng N số Hij là độ cao trung bình của block đất (i,j)  ( 0 $<$= Hij$<$= 10\textasciicircum5)

Q dòng sau, mỗi dòng 2 số Li, Ri ( 0 $<$= Li$<$= Ri$<$= 10\textasciicircum5).
