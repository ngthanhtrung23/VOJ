...
\\
     ...
     Giới hạn    
\begin{itemize}
	\item      0 $<$ N  $\le$  10\textasciicircum5    
	\item      0 $<$ Q  $\le$  3*10\textasciicircum5    
	\item      0 $<$ K  $\le$  60    
	\item      0 $<$ L  $\le$  R  $\le$  n    
	\item      |C|  $\le$  10\textasciicircum7    
	\item      Tổng số lượng phẩn tử của tập S trong tất cả các truy vấn thuộc loại 2  $\le$  10\textasciicircum5.    
	\item      40\% số test N  $\le$  10\textasciicircum4.    
\end{itemize}
