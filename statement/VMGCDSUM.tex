...
\begin{itemize}
	\item     Số S sẽ được cho dưới dạng tích các thừa số nguyên tố và số mũ. Cụ thể hơn, nếu    \textbf{     S = p     $_      1     $$^      k      $_       1      $$     p     $_      2     $$^      k      $_       2      $$     ...p     $_      n     $$^      k      $_       n      $$}    với p    $_     1    $    , p    $_     2    $    , ..., p    $_     n    $    là các số nguyên tố phân biệt thì các giá trị p    $_     1    $    , p    $_     2    $    , ..., p    $_     n    $    và k    $_     1    $    , k    $_     2    $    , ..., k    $_     n    $    sẽ được cho trước.   
